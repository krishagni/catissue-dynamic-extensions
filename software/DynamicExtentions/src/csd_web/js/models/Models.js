var Models = {
  Form : Backbone.Model.extend({
    ...
    addControl : function(controlName, control) {
      control.set({editName : controlName});
      ...
      if (cntrlNames.length == 1) {
        ...
        if (this.get('controlObjectCollection')[cntrlNames[0]]
          .get('subForm').get('controlsOrder').indexOf(cntrlNames[1]) < 0) {
            this.get('controlObjectCollection')[cntrlNames[0]]
              .get('subForm').get('controlsOrder').push(cntrlNames[1]);
        }
      }
    },
    ...
    setControlId : function(controlName, controlId) {
      var cntrlNames = controlName.split(".");
      if (cntrlNames.length == 1) {
        this.get('controlObjectCollection')[controlName].set({id : controlId});
      } else {
        this.get('controlObjectCollection')[cntrlNames[0]]
          .get('subForm')
          .get('controlObjectCollection')[cntrlNames[1]]
          .set({id : controlId});
      }
    },
    ...
    deleteControl : function(controlName) {
      ...
      if (cntrlName.length == 1) {
        ...
        delete this.get('controlObjectCollection')[cntrlName[0]]
          .get('subForm')
          .get('controlObjectCollection')[cntrlName[1]];
      }
    },
